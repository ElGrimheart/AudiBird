...
Analyses an audio recording made using the Pi microphone at a distance of 10m from the control sample.
...
tests/birdnet_validation/test_control_sample_phone_mic.py
...
@pytest.mark.parametrize("audio_file", [
    "tests/audio_samples/Audibird_control_sample_10m_distance_pi_mic.wav"
])
...
def test_analyse_full_recording_and_log(audio_file):
    ...
    # log results 
    log_path = "tests/logs/control_sample_detections_pi_mic_10m_distance.csv"
